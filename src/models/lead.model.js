...
const Lead = sequelize.define("Lead", {
    ...
    leadSource: { type: DataTypes.ENUM("Website", "Referral", "Cold Call", "Other"), defaultValue: "Other" },
    status: { type: DataTypes.STRING, allowNull: true },
    assignByUser: { type: DataTypes.INTEGER, allowNull: true, references: { model: Admin, key: "id" } },
    assignedTo: { type: DataTypes.INTEGER, allowNull: true, references: { model: Admin, key: "id" } },
    isAssigned: { type: DataTypes.BOOLEAN, allowNull: true, defaultValue: false },
